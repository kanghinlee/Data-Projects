...
- The original data sources were donated by Deloitte, extracted from [Equifax Ignite Direct](https://www.equifax.co.uk/) data platform.

- Additional data sources are extracted via [OECD.stat](https://stats.oecd.org/) and [UK National Statistics](https://www.ons.gov.uk/).
...
- Data sets used for analysis contained Time series, Date, Doubles, Numeric & Character. The data sources are contained in Excel files (.xls, .csv, .xlsx etc...) with multiple embedded tabs.
...
The analysis can only provided a high level overview into the topics as there are many confounding variables that are not being taken into consideration per countries. The analysis could be biased for those
